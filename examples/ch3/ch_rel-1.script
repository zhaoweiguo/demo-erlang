%% script generated at {2018,9,4} {15,57,56}
{script,
    {"ch_rel","A"},
    [{preLoaded,
     ...
     {progress,preloaded},
     {path,["$ROOT/lib/kernel-5.2.0.1/ebin","$ROOT/lib/stdlib-3.3/ebin"]},
     {primLoad,
     ...
     {path,["$ROOT/lib/kernel-5.2.0.1/ebin"]},
     {primLoad,
     ...
     {path,["$ROOT/lib/ch3-0.1.0/ebin"]},
     {primLoad,[ch3,ch3_app,ch3_sup]},
     {progress,modules_loaded},
     {path,
         ["$ROOT/lib/kernel-5.2.0.1/ebin","$ROOT/lib/stdlib-3.3/ebin",
          "$ROOT/lib/sasl-3.0.3/ebin","$ROOT/lib/ch3-0.1.0/ebin"]},
     ...
     {apply,{application,start_boot,[ch3,permanent]}},
     {apply,{c,erlangrc,[]}},
     {progress,started}]}.
